...
**Breaking Change in ver 1.0.0**: to use with legacy Bootstrap 4 reference the `BsMultiSelect.bs4.*` bundle|module: e.g. https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/js/BsMultiSelect.bs4.min.js and https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/css/BsMultiSelect.bs4.min.css
...
# CDN
Bootstrap 5
https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/js/BsMultiSelect.min.js
https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/js/BsMultiSelect.esm.min.js
https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/css/BsMultiSelect.min.css

Bootstrap 4
https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/js/BsMultiSelect.bs4.min.js
https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/js/BsMultiSelect.bs4.esm.min.js
https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/css/BsMultiSelect.bs4.min.css
...
````
      ...
      <script src="https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/js/BsMultiSelect.min.js"></script>
...
````
      <script type="module">
            ...
            import {ModuleFactory as dashboardCodeFactory} from "https://cdn.jsdelivr.net/npm/@dashboardcode/bsmultiselect@1.1.6/dist/js/BsMultiSelect.esm.min.js"
