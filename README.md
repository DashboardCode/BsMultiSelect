...
Plugin follows Bootstrap 4 conventions and use the same instruments (babel, sass, rollup) so pretend to present a BS team's modern plugin's **boilerplate**. Learning it you will be familar with Bootstrap components development.
...
**CSS vs SCSS**: you can copy BsMultiSelect.css (included to distribution) and update values manually for your theme.
