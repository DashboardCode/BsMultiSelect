...
function BsAppearancePlugin(pluginData) {
  ...
  let validationApiObservable = validationApiPluginData == null ? void 0 : validationApiPluginData.validationApiObservable;
...
let allPlugins = shallowClearClone(defaultPlugins, {
  PicksPlugin
}); // var defaultConfig = {
