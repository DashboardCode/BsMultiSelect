import { addToJQueryPrototype } from "./AddToJQueryPrototype.js";
import { composeSync, shallowClearClone, ObjectValues, isString } from "./ToolsJs.js";
import { composeEventTrigger } from "./ToolsDom.js";
...
export function createForJQuery(window, $, globalPopper, name, pluginsSet, stylePlugin) {
  ...
  if (isJQyery) {
    let constructorForJquery = (element, settings, removeInstanceData) => {
      let multiSelect = create(element, settings);
